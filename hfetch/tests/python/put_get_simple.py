...
a = Hcache("test","arrays","WHERE token(partid)>=? AND token(partid)<?;",[(-8070430489100700000,8070450532247928832)],["partid"],[{"name":"image_block","type":"double","dims":txt_elem_row+'x'+txt_elem_row,"partition":"false"}],{})
...
resarr = result[0]
print "And the result is... ", resarr.reshape((elem_row,elem_row))
