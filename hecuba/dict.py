...
class PersistentDict(dict):
    ...
    def __iter__(self):
        ...
        return KeyIter(self._ksp, self._table, self._storage_class, self._storage_id, self._primary_keys, self._columns)
...
class context:
    ...
    def __exit__(self):
        ...
        if config.cache_activated:
            ...
            midict.syncs = midict.syncs + midict._batchCount
            config.session.execute(midict._batch)
            midict.batchvar = False
