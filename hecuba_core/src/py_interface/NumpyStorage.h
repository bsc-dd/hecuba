...
public:
    ...
    void *store_numpy_into_coord(const uint64_t *storage_id, PyArrayObject *numpy, PyObject * coord) const;

    void *load_numpy_from_coord(const uint64_t *storage_id, PyObject *coord, PyArrayObject *save);
