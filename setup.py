...
def setup_packages():
    ...
    metadata = dict(name="Hecuba",
                    ...
                    description='Hecuba',
                    author='Guillem Alomar, Yolanda Becerra, Cesare Cugnasco, Adrián Espejo, Ismael Julià, Pol Santamaria',
                    author_email='yolanda.becerra@bsc.es,cesare.cugnasco@bsc.es,ismael.julia@bsc.es',
