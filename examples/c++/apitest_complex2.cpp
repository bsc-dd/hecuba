...
int * generateIntKey(int lat){
  int *keytoreturn=(int *) malloc(sizeof(int));
  memcpy(keytoreturn, &lat, sizeof(int));
  return keytoreturn; 
}
...
int main() {
    ...
    s.loadDataModel("very_simple_model.yaml","very_simple_model.py");
